...
const CardFlexContainer = styled.div`
  ...
  background-color: ${props =>
    props.backgroundColor || colors.defaultCardBackground};
  box-shadow: ${props =>
    props.noShadow ? "none" : "0px 1px 4px 1px rgba(105,105,105,0.63)"};
  .header {
    font-size: 1.2rem;
    font-weight: bold;
    border-radius: 0.2rem;
    ...
    background-color: ${props =>
      props.headerColor || colors.defaultCardHeaderColor};
  }
`;
