...
const ButtonFlexContainer = styled.button`
  ...
  background-color: ${props =>
    props.isError
      ...
      : props.isSuccess
      ? colors.successColor
      : props.backgroundColor || colors.defaultButtonBackground};
  transition: 0.2s all;
  &:hover {
    cursor: pointer;
    background-color: ${props =>
      props.hoverColor || colors.defaultButtonHoverColor};
    color: ${props =>
      props.hoverTextColor || colors.defaultButtonHoverTextColor};
  }
`;
